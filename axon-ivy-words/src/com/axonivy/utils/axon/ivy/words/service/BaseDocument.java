...
public abstract class BaseDocument {
  ...
  public static final String[] SUPPORTED_OUTPUT_FORMATS = new String[] {"doc", "docx"};
  ...
  public static BaseDocument getInstance() {
    try {
      if (StringUtils.isBlank(System.getProperty(DOCUMENT_IMPLEMENTATION_SYSTEM_PROPERTY))) {
        ...
        return (BaseDocument) Class.forName(System.getProperty("axonivy.document")).getDeclaredConstructor()
            .newInstance();
      }
    } catch (Exception e) {
  ...
  public abstract File generateDocumentWithRegions(String templatePath, String outputName, String outPath,
