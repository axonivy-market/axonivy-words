...
public class ConvertDocumentBean implements Serializable {
  ...
  public StreamedContent getConvertedFile() {
    ...
    return DefaultStreamedContent.builder().name(CONVERTED_DEMO_FILE_NAME).contentType("application/pdf")
        .stream(() -> new ByteArrayInputStream(DocumentUtils.convertTo(SaveFormat.PDF, DEFAULT_SAMPLE_FILE_PATH)))
        .build();
  }
}
