...
public class AsposeDocumentTest {
  ...
  void generateDocumentWithRegions_shouldReturnNull_whenTemplatePathBlank() {
    File result = asposeDocument.generateDocumentWithRegions("", "output", TEST_OUTPUT_DIR, null, null);
    assertThat(result).isNull();
  }

  @Test
  void generateDocumentWithRegions_shouldReturnNull_whenTemplateDoesNotExist() {
    File result = asposeDocument.generateDocumentWithRegions("not-exist.docx", "output", TEST_OUTPUT_DIR, null, null);
    assertThat(result).isNull();
  }
